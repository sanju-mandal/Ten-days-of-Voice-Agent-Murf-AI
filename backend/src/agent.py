...
CONTENT_FILE = "AgenticAi_content.json" 
...
DEFAULT_CONTENT = [
  {
    "id": "agentic_ai",
    "title": "Agentic AI",
    "summary": "Agentic AI refers to artificial intelligence systems capable of autonomous goal-directed behavior. These agents can plan, take actions, interact with the environment, and self-improve without manual step-by-step instructions.",
    "sample_question": "What makes Agentic AI different from traditional AI or LLMs?"
  },
  {
    "id": "ai_agents",
    "title": "AI Agents",
    "summary": "AI agents are autonomous systems designed to sense, reason, and act to achieve goals. Agents can analyze context, break tasks into steps, use tools (APIs), and evaluate results.",
    "sample_question": "How do AI agents use tools such as web search or code execution?"
  },
  {
    "id": "agent_architecture",
    "title": "Agent Architecture",
    "summary": "Agent architectures define how an agent thinks and acts. Common architectures include ReAct (reason + act), Auto-GPT-style planning, multi-agent collaboration, and hierarchical task management.",
    "sample_question": "What is the ReAct framework and why is it important for modern agents?"
  },
  {
    "id": "use_cases",
    "title": "Agentic AI Use Cases",
    "summary": "Agentic AI is used for automated research, customer support, software development, workflow automation, tutoring systems, and personal productivity assistants.",
    "sample_question": "Give examples of real-world applications where agentic AI can perform tasks autonomously."
  }
]
...
def load_content():
    """
    📖 Checks if Agentic AI JSON exists. 
    ...
    try:
        ...
        if not os.path.exists(path):
            print(f"⚠️ {CONTENT_FILE} not found. Generating agentic AI data...")
            with open(path, "w", encoding='utf-8') as f:
                json.dump(DEFAULT_CONTENT, f, indent=4)
            print("✅ Agentic AI content file created successfully.")
...
async def select_topic(
    ...
    topic_id: Annotated[str, Field(description="The ID of the topic to study (e.g., 'agent_architecture', 'use_cases', 'ai_agents', etc.)")]
) -> str:
...
class TutorAgent(Agent):
    def __init__(self):
        ...
        super().__init__(
            instructions=f"""
            You are an Agentic AI Tutor designed to help users master concepts like AI agents and more.
...
async def entrypoint(ctx: JobContext):
    ...
    print("🚀 STARTING Agentic AI TUTOR SESSION")
